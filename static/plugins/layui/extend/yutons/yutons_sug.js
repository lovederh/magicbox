...
layui.define(['jquery', 'table'], function(exports) {
	...
	yutons_sug.prototype.render = function(opt) {
		...
		opt.cellMinWidth = opt.cellMinWidth || '100%'; //最小列宽
		...
		//初始化输入框提示容器
		$("#" + opt.id).after("<div id='sugItem' style='background-color:#F8F8F8;display: none;z-index:1;position: absolute;width:" + opt.cellMinWidth + ";'></div>");
